...
### 各ユーザーの勤怠情報、修正申請について
各ユーザーの勤怠情報については、当月を含む3ヶ月分が作成されます（当月は昨日までの勤怠が作成されます）。<br>
※例外として、1日にマイグレーションを行った場合は、前月～3ヶ月前までの勤怠情報が作成されます。<br>
<br>
修正申請については、各ユーザーに対して以下の3つが作成されます。<br>
　1. 勤怠時刻の修正申請<br>
　2. 休憩時刻の修正申請<br>
　3. 勤怠漏れに対する修正申請<br>
※上記1～2についてはランダムな日付で作成され、3については「当月の最初の平日」を対象として作成されます。そのため、当月の最初の平日の退勤は必ずNULLになります（1日にマイグレーションを行った場合は、前月の最初の平日が対象となります）。<br>
<br>
