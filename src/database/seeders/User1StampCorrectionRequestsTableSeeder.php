...
class User1StampCorrectionRequestsTableSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        // 勤怠修正
        $attendance1 = Attendance::where('user_id', $user1->id)
        ...
        $afterClockIn = $baseDate1->copy()->setTime(9, 0);
        $afterClockOut = $baseDate1->copy()->setTime(18, 0);
        ...
        // 休憩修正
        $attendance2 = Attendance::where('user_id', $user1->id)
            ->has('breakTimes')
            ->whereNotNull('clock_out')
            ->inRandomOrder()
            ->first();
        ...
        $afterStart = $baseDate2->copy()->setTime(12, 0);
        $afterEnd = $baseDate2->copy()->setTime(13, 0);
        ...
        // 退勤漏れ
        $attendance3 = Attendance::where('user_id', $user1->id)
            ->whereNull('clock_out')
            ->first();
        ...
        $afterClockOut = $baseDate3->copy()->setTime(18, 0);
